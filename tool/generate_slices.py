...
SLICES = [
    ...
    ("E4", "Bean fill + PB confetti", "pending", ["C2"], ["E3"],
     ...
     "cd app/flowlog && flutter test",
     "none"),
    ("E5", "Desktop keyboard shortcuts", "done", ["A5", "C2"], ["E6"],
    ...
    ("E6", "Accessibility pass", "pending", ["A5", "C3"], ["E1", "E5"],
     ...
     "cd app/flowlog && flutter test",
     "none"),
    ("E7", "Sensor diagnostics", "done", ["B7"], ["E6"],
