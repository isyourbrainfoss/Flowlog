...
void main() {
  ...
  group('GodShotFab', () {
    testWidgets('is visible on Live tab', (tester) async {
      ...
      expect(find.byKey(const Key('god_shot_fab')), findsOneWidget);
      expect(find.text('God Shot'), findsOneWidget);
    });
    ...
    testWidgets('is disabled until session is stopped with samples', (
      ...
      final fab = tester.widget<FloatingActionButton>(
        find.byKey(const Key('god_shot_fab')),
      );
  ...
  group('runGodShotSaveFlow', () {
    ...
    testWidgets('opens metadata sheet, saves shot, and shows snackbar', (
      ...
      await tester.tap(find.byKey(const Key('god_shot_fab')));
